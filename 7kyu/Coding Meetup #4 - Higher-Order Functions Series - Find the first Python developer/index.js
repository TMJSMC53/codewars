/*
Title: Coding Meetup #4 - Higher-Order Functions Series - Find the first Python developer
...
function getFirstPython(list) {
  let findDev = list.find((dev) => dev.language === "Python");
  return findDev
    ? `${findDev.firstName}, ${findDev.country}`
