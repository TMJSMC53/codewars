/*
Title: Training JS #25: methods of arrayObject---reverse() and sort()

Description: This lesson we learn two sorting methods: reverse() and sort().
...
function sortIt(arr) {
  return arr.slice().sort((a, b) => {
    let arr1 = arr.filter((x) => x === a).length;
    let arr2 = arr.filter((x) => x === b).length;

    if (arr1 === arr2) return b - a;
