/*
Title: Custom Array Filters
Description: Dave has a lot of data he is required to apply filters to, which are simple enough, but he wants a shorter way of doing so.
...
Array.prototype.odd = function () {
  return this.filter((num) => Number.isInteger(num) && num % 2 === 1);
};
Array.prototype.under = function (x) {
  return this.filter((num) => Number.isInteger(num) && num < x);
};
Array.prototype.over = function (x) {
  return this.filter((num) => Number.isInteger(num) && num > x);
};

Array.prototype.inRange = function () {
  return this.filter(
