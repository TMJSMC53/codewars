...
Description: You are given a program squaresOnly that accepts an array of natural numbers up to and including 100 (and including 0) of length >= 1, array, and returns a new array containing only square numbers that have appeared in the input array.
...
const squaresOnly = (arr) =>
  arr.filter((num) => Number.isInteger(Math.sqrt(num)));
